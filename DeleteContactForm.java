...
/////////////////////////////////// Center panel ///////////////////////////////////////////////////////////
        ...
        searchButton.addActionListener(new ActionListener() {
         public void actionPerformed(ActionEvent evt) {
                String input = searchText.getText();
                 contact = ContactController.searchContact(input);
                if (contact != null){
		...
		///////______________________| Delete Contact |___________________/////////
		
		deleteButton=new JButton("      Delete      ");
		deleteButton.setFont(new Font("",1,18)); 


		deleteButton.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent evt){
          			boolean isAdded=ContactController.deleteContact(contact);
				if(isAdded){
					JOptionPane.showMessageDialog(null,"Deleted Success");
					int op = JOptionPane.showOptionDialog(null, "Do you want to delete another contact?", "Confirmation", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, null, null);
